...
from ..common.utils.error_handler import register_exception_handlers
...
def create_application(
    ...
    if _security_headers_enabled:
        _environment = settings.ENVIRONMENT.value if hasattr(settings,
                                                             "ENVIRONMENT") else EnvironmentOption.DEVELOPMENT.value
    ...
    if show_docs:
        ...
        is_production = isinstance(settings,
                                   EnvironmentSettings) and settings.ENVIRONMENT == EnvironmentOption.PRODUCTION
